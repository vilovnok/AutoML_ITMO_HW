...
- Итоговое улучшение по сравнению с лучшей моделью LightAutoML составило около 0.02 RMSLE, что показывает, что за счёт ручной обработки данных возможно получить лучшие результаты.
